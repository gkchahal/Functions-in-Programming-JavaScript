...
function startattack() {
  ...
  dragonEle.innerHTML = "The dragon's Health: " + dragonHealth;
   function buttonWarrior(warList) {
    var warrior = document.createElement("button");
    warrior.innerHTML = warList.name + "'s health: " + warList.health;
   ...
   function attackDragon(damage, type, object, element) {
    ...
    if (object.health <= 0) {
      ...
      element.innerHTML = object.name + "'s health: " + object.health;
    }
